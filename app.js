...
const equipment = [
 {cat:"poultry",icon:"🐔",image:"catalog-broiler.jpg",en:["Broiler House Systems","Housing, feeding, drinking, climate and automation solutions."],ru:["Системы для бройлерных птичников","Содержание, кормление, поение, климат и автоматизация."],uz:["Broyler parrandaxona tizimlari","Saqlash, oziqlantirish, sug‘orish, iqlim va avtomatlashtirish yechimlari."]},
 {cat:"poultry",icon:"🥚",image:"catalog-layer.jpg",en:["Layer Cage Systems","Layer housing, egg collection, manure removal and climate systems."],ru:["Клеточные системы для несушек","Содержание несушек, сбор яиц, удаление помёта и климатические системы."],uz:["Tuxumchi tovuqlar uchun qafas tizimlari","Tuxumchi tovuqlarni saqlash, tuxum yig‘ish, go‘ng chiqarish va iqlim tizimlari."]},
 {cat:"poultry",icon:"🐣",image:"catalog-hatchery.jpg",en:["Hatchery Equipment","Incubators, hatchers and chick handling systems."],ru:["Инкубационное оборудование","Инкубаторы, выводные шкафы и системы обработки цыплят."],uz:["Inkubatsiya uskunalari","Inkubatorlar, jo‘ja chiqarish va jo‘jalarni qayta ishlash tizimlari."]},
 {cat:"processing",icon:"🏭",image:"catalog-poultry-processing.jpg",en:["Poultry Processing Lines","Slaughter, chilling, cutting, packing and cold-chain lines."],ru:["Линии переработки птицы","Убой, охлаждение, разделка, упаковка и холодовая цепь."],uz:["Parrandani qayta ishlash liniyalari","So‘yish, sovitish, bo‘laklash, qadoqlash va sovuq zanjir liniyalari."]},
 {cat:"agriculture",icon:"🚜",image:"catalog-tractor.jpg",en:["Tractors & Implements","Tractors, tillage, seeding, spraying and harvesting equipment."],ru:["Тракторы и навесное оборудование","Тракторы, обработка почвы, посев, опрыскивание и уборочная техника."],uz:["Traktorlar va agregatlar","Tuproqqa ishlov berish, ekish, purkash va yig‘im-terim texnikasi."]},
 {cat:"agriculture",icon:"💧",image:"catalog-irrigation.jpg",en:["Irrigation Systems","Drip, sprinkler, pumps, filtration and fertigation systems."],ru:["Системы орошения","Капельное и дождевальное орошение, насосы, фильтрация и фертигация."],uz:["Sug‘orish tizimlari","Tomchilatib va yomg‘irlatib sug‘orish, nasoslar, filtrlash va fertigasiyа."]},
 {cat:"processing",icon:"🌾",image:"catalog-feedmill.jpg",en:["Feed Mill Equipment","Grinding, mixing, pelleting, conveying and storage systems."],ru:["Оборудование комбикормовых заводов","Измельчение, смешивание, гранулирование, транспортировка и хранение."],uz:["Yem zavodi uskunalari","Maydalash, aralashtirish, granulalash, tashish va saqlash tizimlari."]},
 {cat:"processing",icon:"🥛",image:"catalog-dairy.jpg",en:["Dairy Processing Lines","Milk reception, pasteurization, fermentation, filling and CIP."],ru:["Линии переработки молока","Приём молока, пастеризация, ферментация, розлив и CIP-мойка."],uz:["Sutni qayta ishlash liniyalari","Sut qabul qilish, pasterizatsiya, fermentatsiya, quyish va CIP yuvish."]},
 {cat:"industrial",icon:"❄️",image:"catalog-cold-storage.jpg",en:["Cold Storage Solutions","Cold rooms, refrigeration units, insulated panels and controls."],ru:["Холодильные решения","Холодильные камеры, агрегаты, сэндвич-панели и системы управления."],uz:["Sovuq saqlash yechimlari","Sovutish kameralari, agregatlar, izolyatsion panellar va boshqaruv tizimlari."]},
 {cat:"industrial",icon:"⚡",image:"catalog-generator.jpg",en:["Generators & Power Systems","Diesel generators, backup power and industrial energy systems."],ru:["Генераторы и энергосистемы","Дизельные генераторы, резервное питание и промышленные энергосистемы."],uz:["Generatorlar va energiya tizimlari","Dizel generatorlar, zaxira quvvati va sanoat energiya tizimlari."]},
 {cat:"energy",icon:"☀️",image:"catalog-solar.jpg",en:["Solar Energy Systems","Solar modules, inverters, storage and project components."],ru:["Солнечные энергосистемы","Солнечные модули, инверторы, накопители и компоненты проектов."],uz:["Quyosh energiyasi tizimlari","Quyosh modullari, invertorlar, akkumulyatorlar va loyiha komponentlari."]},
 {cat:"industrial",icon:"💧",image:"catalog-water-treatment.jpg",en:["Water Treatment","Filtration, RO, treatment and industrial water systems."],ru:["Водоочистка","Фильтрация, обратный осмос и промышленные системы водоподготовки."],uz:["Suvni tozalash","Filtrlash, teskari osmos va sanoat suv tayyorlash tizimlari."]}
];
...
function renderEquipment(){
  ...
  document.getElementById("equipmentGrid").innerHTML=list.map(x=>{
    ...
    return `<article class="equipment-card">
      <div class="equipment-photo"><img src="${x.image}" alt="${txt[0]}" loading="lazy" decoding="async"></div>
      <h3>${txt[0]}</h3>
      <p>${txt[1]}</p>
